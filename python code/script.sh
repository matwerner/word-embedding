...
#python3 preprocessing.py --n_articles $ARTICLES --n_tokens $TOKENS --wiki_dump $DUMP_PATH --full_vocab $FULL_VOCAB_PATH --limited_vocab $LIMITED_VOCAB_PATH --stopwords $STOPWORDS
